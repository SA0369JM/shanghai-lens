...
scenes = [
    {"img": "assets/scenes/COMP5415_Scene_2.png", 
     "text": "Breakfast often begins with Shanghai \"four guardians\". These traditional youtiao (油条), sesame flatbread (大饼), fried glutinous rice cake (糍饭糕), and soy milk (豆浆) - bring warmth and flavor to start a beautiful morning. "},
    
    {"img": "assets/scenes/COMP5415_Scene_3.png", 
     "text": "After breakfast, the walk continue to CHENGHUANGMIAO. Jiuqu Bridge is a must-cross each time with a no walk back tradition, which symbolizing tradition and fortune. At the end of the bridge, the famous Nanxiang steamed buns await, offering a delicious taste that completes the journey."},
